...
import org.lsj.viewpagerapp.databinding.ActivityMainBinding
import org.lsj.viewpagerapp.databinding.ItemBinding
import org.lsj.viewpagerapp.databinding.MovieLayoutBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ids= arrayOf(R.drawable.mov01,R.drawable.mov02,R.drawable.mov03,R.drawable.mov04,R.drawable.mov05,R.drawable.mov06,R.drawable.mov07,R.drawable.mov08,R.drawable.mov09,R.drawable.mov10)
        val datas = mutableListOf<Movie>()
        val titles= arrayOf("써니","완득이","괴물","라디오스타","비열한거리","왕의 남자","아일랜드","웰컴투 동막골","웹보이","백투더 퓨처")
        for(i in 1..9){
